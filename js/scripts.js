        ...
        const productosDisponibles = [
            { codigo: 'PROD-001', nombre: 'Zapato Para Tenis Joma De Hombre Roland', precio: 433.990 },
            { codigo: 'PROD-002', nombre: 'Jordan Brooklyn', precio: 199.950 },
            { codigo: 'PROD-003', nombre: 'Nike FC Barcelona Stadium 3rd Jersey', precio: 534.950 },
            { codigo: 'PROD-004', nombre: 'Zapato Hombre Skechers Skechersvipercourtreload Ne', precio: 389.900 }
        ];
            ...
            productosDisponibles.forEach((producto, index) => {
                ...
                row.innerHTML = `
                    <div class="form-group" style="margin:0;">
                        <img src="imagenes/imagen1.1${index + 1}.jpg" 
                             alt="${producto.nombre}" 
